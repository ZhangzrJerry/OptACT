...
A1_GRIPPER_POSITION_NORMALIZE_FN = lambda x: (x - A1_GRIPPER_POSITION_CLOSE) / (
    A1_GRIPPER_POSITION_OPEN - A1_GRIPPER_POSITION_CLOSE
)
A1_GRIPPER_POSITION_UNNORMALIZE_FN = (
    lambda x: x * (A1_GRIPPER_POSITION_OPEN - A1_GRIPPER_POSITION_CLOSE)
...
A1_GRIPPER_VELOCITY_NORMALIZE_FN = lambda x: x / (
    A1_GRIPPER_POSITION_OPEN - A1_GRIPPER_POSITION_CLOSE
)
